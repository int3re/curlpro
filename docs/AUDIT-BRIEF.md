...
This file is the original; [AUDIT-BRIEF.ru.md](AUDIT-BRIEF.ru.md) is its Russian
twin. A test checks that the two keep the same structure, so a section added to
one and forgotten in the other fails the build rather than drifting quietly.
